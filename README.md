...
A curated, copy-paste reference of the web interactions used by award-winning design agencies. **300 hand-built patterns** — each with a live demo, a single-file code snippet, and a ready-to-paste LLM prompt. The original roadmap is complete and the likes-driven expansion is underway.
...
**Expansion categories live:** Maps & Geo (6) · FUI & Terminal (10) · Agent & AI UI (2).
**Roadmap:** All 236 original handoff items are published; 29 of 56 likes-driven expansion items are live, with 27 queued.
