...
A curated, copy-paste reference of the web interactions used by award-winning design agencies. **278 hand-built patterns** — each with a live demo, a single-file code snippet, and a ready-to-paste LLM prompt. The original roadmap is complete and the likes-driven expansion is underway.
...
**Expansion categories live:** FUI & Terminal (7). Maps & Geo and Agent & AI UI are wired and will appear when their first demos ship.
**Roadmap:** All 236 original handoff items are published; 7 of 56 likes-driven expansion items are live, with 49 queued.
