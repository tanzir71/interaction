...
if (demos.length !== 290) errors.push('DEMO COUNT ' + demos.length + ', expected 290');
if (files.length !== 241) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 241');
if (handoff2Published !== 19) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 19');
