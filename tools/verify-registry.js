...
if (demos.length !== 297) errors.push('DEMO COUNT ' + demos.length + ', expected 297');
if (files.length !== 248) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 248');
if (handoff2Published !== 26) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 26');
