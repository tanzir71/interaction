...
if (demos.length !== 299) errors.push('DEMO COUNT ' + demos.length + ', expected 299');
if (files.length !== 250) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 250');
if (handoff2Published !== 28) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 28');
