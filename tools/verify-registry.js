...
if (demos.length !== 298) errors.push('DEMO COUNT ' + demos.length + ', expected 298');
if (files.length !== 249) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 249');
if (handoff2Published !== 27) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 27');
