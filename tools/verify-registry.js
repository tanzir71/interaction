...
if (demos.length !== 314) errors.push('DEMO COUNT ' + demos.length + ', expected 314');
if (files.length !== 265) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 265');
if (handoff2Published !== 43) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 43');
