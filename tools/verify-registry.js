...
if (demos.length !== 300) errors.push('DEMO COUNT ' + demos.length + ', expected 300');
if (files.length !== 251) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 251');
if (handoff2Published !== 29) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 29');
