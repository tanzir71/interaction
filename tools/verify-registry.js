...
if (demos.length !== 293) errors.push('DEMO COUNT ' + demos.length + ', expected 293');
if (files.length !== 244) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 244');
if (handoff2Published !== 22) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 22');
