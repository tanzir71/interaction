...
if (demos.length !== 303) errors.push('DEMO COUNT ' + demos.length + ', expected 303');
if (files.length !== 254) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 254');
if (handoff2Published !== 32) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 32');
