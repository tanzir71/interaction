...
if (demos.length !== 291) errors.push('DEMO COUNT ' + demos.length + ', expected 291');
if (files.length !== 242) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 242');
if (handoff2Published !== 20) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 20');
