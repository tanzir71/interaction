...
if (demos.length !== 292) errors.push('DEMO COUNT ' + demos.length + ', expected 292');
if (files.length !== 243) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 243');
if (handoff2Published !== 21) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 21');
