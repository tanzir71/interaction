...
if (demos.length !== 304) errors.push('DEMO COUNT ' + demos.length + ', expected 304');
if (files.length !== 255) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 255');
if (handoff2Published !== 33) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 33');
