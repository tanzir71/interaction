...
if (demos.length !== 313) errors.push('DEMO COUNT ' + demos.length + ', expected 313');
if (files.length !== 264) errors.push('REGISTRY FILE COUNT ' + files.length + ', expected 264');
if (handoff2Published !== 42) errors.push('HANDOFF 2 PUBLISHED ' + handoff2Published + ', expected 42');
