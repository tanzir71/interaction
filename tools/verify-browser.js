...
const EXPECTED_CARDS = 271; /* keep in sync with the published registries */
const targets = [
...
async function browserCheck(ids, expected, dwell = 700) {
  ...
  for (let i = 0; i < 120 && document.querySelectorAll('#cards > .card').length < expected; i++) await wait(100);
