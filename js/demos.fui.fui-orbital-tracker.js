...
.d-fui-orbit:before{content:'';position:absolute;inset:0;z-index:10;pointer-events:none;background:repeating-linear-gradient(0deg,transparent 0 2px,rgba(255,255,255,.018) 2px 3px),radial-gradient(circle at 42% 54%,rgba(250,115,25,.035),transparent 43%)}
...
.d-fui-orbit-live{display:flex;align-items:center;gap:5px;color:#9b9ba3}.d-fui-orbit-live i{width:5px;height:5px;border-radius:50%;background:#fa7319;box-shadow:0 0 8px rgba(250,115,25,.42)}.d-fui-orbit-live b{color:#ececef;font:inherit}
...
.d-fui-orbit-scene:hover{border-color:#2e2e34}.d-fui-orbit-scene:focus-visible{outline:2px solid rgba(250,115,25,.72);outline-offset:-3px;border-color:#fa7319}
...
.d-fui-orbit-trail{fill:#ececef}.d-fui-orbit-trail[data-selected="true"]{fill:#fa7319}.d-fui-orbit-trails-back,.d-fui-orbit-heads-back{opacity:.25}
.d-fui-orbit-head{fill:#ececef;stroke:#101012;stroke-width:.75;vector-effect:non-scaling-stroke}.d-fui-orbit-head[data-selected="true"]{fill:#fa7319;filter:drop-shadow(0 0 4px #fa7319)}
...
.d-fui-orbit-leader{fill:none;stroke:#fa7319;stroke-width:1;stroke-opacity:.58;vector-effect:non-scaling-stroke}
.d-fui-orbit-readout{position:absolute;z-index:4;top:12px;right:9px;width:132px;min-height:41px;box-sizing:border-box;padding:6px 6px 5px 9px;border-left:2px solid #fa7319;background:rgba(10,10,11,.88);color:#ececef;font:500 10px/1.45 'JetBrains Mono',monospace;letter-spacing:.03em;white-space:normal;pointer-events:none}.d-fui-orbit-readout>span{display:block;margin-bottom:2px;color:#5c5c66;font-size:9px;letter-spacing:.08em}.d-fui-orbit-readout-text{font:inherit}.d-fui-orbit[data-typing="true"] .d-fui-orbit-readout-text:after{content:'';display:inline-block;width:2px;height:10px;margin-left:2px;background:#fa7319;vertical-align:-1px}
