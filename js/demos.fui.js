...
.d-fui-status:before{content:'';position:absolute;inset:0;z-index:-1;background:repeating-linear-gradient(0deg,transparent 0 2px,rgba(255,255,255,.02) 2px 3px),radial-gradient(circle at 50% 45%,rgba(167,139,250,.06),transparent 48%);pointer-events:none}
...
.d-fui-status-kicker{color:#9b9ba3}.d-fui-status-live{display:flex;align-items:center;gap:6px;color:#a78bfa}
.d-fui-status-live-dot{width:5px;height:5px;border-radius:50%;background:#a78bfa;box-shadow:0 0 9px rgba(167,139,250,.55);animation:d-fui-status-live-pulse 1.6s ease-in-out infinite}
...
.d-fui-status-panel:hover .d-fui-status-corner,.d-fui-status-panel:focus-visible .d-fui-status-corner{border-color:#a78bfa;opacity:1}
...
.d-fui-status-panel:hover .d-fui-status-metric strong,.d-fui-status-panel:focus-visible .d-fui-status-metric strong{font-size:14px;color:#a78bfa}.d-fui-status-metric span{margin-top:5px;color:#5c5c66;font-size:8px;letter-spacing:.08em}.d-fui-status-metric small{margin-top:6px;color:#9b9ba3;font-size:8px}
.d-fui-status-power-bars{width:48px;height:94px;display:flex;flex-direction:column-reverse;justify-content:flex-start;gap:2px}.d-fui-status-power-bars i{display:block;height:6px;background:#a78bfa;opacity:.92;box-shadow:0 0 5px rgba(167,139,250,.22)}.d-fui-status-power-bars i:last-child{animation:d-fui-status-power-top 1.2s ease-in-out infinite}
...
.d-fui-status-needle{position:absolute;left:50%;bottom:8px;width:1px;height:48px;background:#a78bfa;box-shadow:0 0 8px rgba(167,139,250,.5);transform-origin:50% 100%;transform:rotate(var(--d-fui-status-thermal-angle,26deg));will-change:transform}.d-fui-status-needle-pin{position:absolute;left:calc(50% - 4px);bottom:4px;width:8px;height:8px;border:1px solid #a78bfa;border-radius:50%;background:#101012}
...
.d-fui-status-scanline{position:absolute;z-index:4;left:15px;right:15px;top:7px;height:1px;background:#a78bfa;box-shadow:0 0 7px rgba(167,139,250,.35);opacity:.12;pointer-events:none;animation:d-fui-status-scan 7s linear infinite}.d-fui-status-clock{color:#9b9ba3}
...
if(reduced){
  ...
  prompt:`Build a 320px-tall sci-fi status dashboard with a 2 by 2 grid of hard-tech panels named POWER, THERMALS, SHIELD, and DIAGNOSTICS. Use only #0a0a0b, #101012, #161619, #232327, #2e2e34, #ececef, #9b9ba3, #5c5c66, accent #a78bfa, success #4ade80, warning #fbbf24, error #f87171, and info #67e8f9. Use JetBrains Mono throughout, 4px panel radii, 1px borders, four L-shaped corner ticks per panel, scanlines, and a visible accent activity light.
