...
.d-fui-hex-topbar,.d-fui-hex-footer{position:relative;z-index:13;display:flex;align-items:center;justify-content:space-between;color:#5c5c66;font-size:10px;line-height:1;letter-spacing:.08em}.d-fui-hex-live{display:flex;align-items:center;gap:6px;color:#9b9ba3}.d-fui-hex-live-dot{width:5px;height:5px;border-radius:50%;background:#fa7319;box-shadow:0 0 9px rgba(250,115,25,.35);animation:d-fui-hex-live-pulse 1.6s ease-in-out infinite}
...
.d-fui-hex-viewport{position:absolute;left:0;right:0;top:19px;bottom:0;overflow:hidden;outline:none}.d-fui-hex-viewport:focus-visible{box-shadow:inset 0 0 0 2px rgba(250,115,25,.4)}.d-fui-hex-rows{position:absolute;left:0;right:0;top:0;will-change:transform}.d-fui-hex-row{height:16px;box-sizing:border-box;align-items:center;padding:0 4px;border-bottom:1px solid rgba(35,35,39,.45);font-variant-numeric:tabular-nums}
