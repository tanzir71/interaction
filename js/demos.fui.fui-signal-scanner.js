...
.d-fui-scan-tip{position:absolute;left:0;top:0;width:2px;height:2px;background:#a78bfa;transform:translateY(var(--d-fui-scan-shift));will-change:transform}.d-fui-scan-bar.d-fui-scan-is-selected .d-fui-scan-tip{background:#67e8f9}.d-fui-scan-blip{position:absolute;left:-1px;top:-7px;width:4px;height:4px;border-radius:50%;background:#f87171;box-shadow:0 0 9px rgba(248,113,113,.45);opacity:0;transform:translateY(var(--d-fui-scan-shift)) scale(var(--d-fui-scan-blip-scale));will-change:opacity,transform}
