...
.d-fui-scope-topbar,.d-fui-scope-footer{position:relative;z-index:8;display:flex;align-items:center;justify-content:space-between;color:#5c5c66;font-size:9px;line-height:1;letter-spacing:.08em}.d-fui-scope-live{display:flex;align-items:center;gap:6px;color:#9b9ba3}.d-fui-scope-live-dot{width:5px;height:5px;border-radius:50%;background:#fa7319;box-shadow:0 0 9px rgba(250,115,25,.35);animation:d-fui-scope-live-pulse 1.6s ease-in-out infinite}
.d-fui-scope-panel{position:relative;z-index:2;min-height:0;overflow:hidden;border:1px solid #232327;border-radius:4px;background:#101012}.d-fui-scope-canvas{display:block;width:100%;height:100%;outline:none;cursor:crosshair;touch-action:none}.d-fui-scope-canvas:focus-visible{box-shadow:inset 0 0 0 2px rgba(250,115,25,.55)}
...
if(reduced){phase=.55;renderFrame(false);expose('reduced')}else start();`,
  prompt:`Build a self-contained 320px-tall fictional oscilloscope using one visible canvas and one persistent offscreen trail canvas. Use JetBrains Mono and only #0a0a0b, #101012, #232327, #2e2e34, #ececef, #9b9ba3, #5c5c66, accent #fa7319, success #4ade80, and warning #fbbf24. Frame the scope as a 4px-radius FUI panel with four 8px corner ticks, scanlines, a visible accent activity dot, a top-left live readout, and a warning HOLD chip.
