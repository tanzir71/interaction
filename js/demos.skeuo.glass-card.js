...
<div class="d-glass-card" tabindex="0" aria-label="Interactive glass refraction card. Move or use arrow keys, Space pins the light, R changes refraction, Home centers, and Escape releases.">
  ...
  css: `
.d-glass-card { --gx:50%;--gy:50%;--tilt-x:0deg;--tilt-y:0deg;--shift-x:0px;--shift-y:0px;--light:0;--distortion:1;--edge-t:0;--edge-r:0;--edge-b:0;--edge-l:0; width:100%;min-height:500px;position:relative;overflow:hidden;box-sizing:border-box;padding:38px 20px 64px;color:#f2f4f7;background:#090c12;outline:none;perspective:900px;font-family:Inter,system-ui,sans-serif }
