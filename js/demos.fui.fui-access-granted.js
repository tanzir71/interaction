...
.d-fui-auth-topbar,.d-fui-auth-footer{position:relative;z-index:13;display:flex;align-items:center;justify-content:space-between;color:#5c5c66;font-size:10px;line-height:1;letter-spacing:.08em}.d-fui-auth-live{display:flex;align-items:center;gap:6px;color:#9b9ba3}.d-fui-auth-live-dot{width:5px;height:5px;border-radius:50%;background:#fa7319;box-shadow:0 0 9px rgba(250,115,25,.35);animation:d-fui-auth-live-pulse 1.6s ease-in-out infinite}
.d-fui-auth-panel{position:relative;z-index:2;display:block;width:100%;min-height:0;overflow:hidden;box-sizing:border-box;padding:0;border:1px solid #232327;border-radius:4px;background:#101012;color:inherit;font:inherit;text-align:inherit;appearance:none;cursor:pointer;outline:none}.d-fui-auth-panel:focus-visible{box-shadow:inset 0 0 0 2px rgba(250,115,25,.45)}.d-fui-auth-panel-head{position:absolute;z-index:8;left:10px;right:10px;top:8px;display:flex;justify-content:space-between;color:#5c5c66;font-size:10px;line-height:1;letter-spacing:.08em}.d-fui-auth-mode{color:#9b9ba3}
.d-fui-auth-core{position:absolute;z-index:3;left:50%;top:30px;width:150px;display:flex;flex-direction:column;align-items:center;transform:translateX(-50%)}.d-fui-auth-glyph{display:block;width:128px;height:128px;overflow:visible;transform-origin:50% 50%;will-change:transform}.d-fui-auth-arc{fill:none;stroke:#5c5c66;stroke-width:2.5;stroke-linecap:square;transform-origin:80px 80px}.d-fui-auth-arc-1{stroke-dasharray:18 8;transform:rotate(12deg)}.d-fui-auth-arc-2{stroke-dasharray:26 11;transform:rotate(-21deg)}.d-fui-auth-arc-3{stroke-dasharray:34 14;transform:rotate(34deg)}.d-fui-auth-arc-4{stroke-dasharray:42 17;transform:rotate(-9deg)}.d-fui-auth-arc-5{stroke-dasharray:52 21;transform:rotate(23deg)}.d-fui-auth-center{fill:#fa7319}.d-fui-auth-label{margin-top:2px;color:#5c5c66;font-size:10px;line-height:1;letter-spacing:.08em;animation:d-fui-auth-await 1.4s ease-in-out infinite}.d-fui-auth.d-fui-auth-is-active .d-fui-auth-arc{stroke:#fa7319}.d-fui-auth.d-fui-auth-is-active .d-fui-auth-label{color:#fa7319;animation:none}.d-fui-auth.d-fui-auth-has-result .d-fui-auth-glyph{opacity:.18}.d-fui-auth.d-fui-auth-has-result .d-fui-auth-label{opacity:0}
...
.d-fui-auth-sweep{position:absolute;z-index:6;left:0;right:0;top:0;height:1px;background:#fa7319;box-shadow:0 0 12px rgba(250,115,25,.35);opacity:0;will-change:transform,opacity}.d-fui-auth-footer{border-top:1px solid #232327}.d-fui-auth-state{color:#4ade80}.d-fui-auth.d-fui-auth-is-active .d-fui-auth-state{color:#fa7319}.d-fui-auth.d-fui-auth-is-denied .d-fui-auth-state{color:#f87171}
.d-fui-auth-corner{position:absolute;z-index:9;width:8px;height:8px;pointer-events:none}.d-fui-auth-corner-tl{left:3px;top:3px;border-left:2px solid #2e2e34;border-top:2px solid #2e2e34}.d-fui-auth-corner-tr{right:3px;top:3px;border-right:2px solid #2e2e34;border-top:2px solid #2e2e34}.d-fui-auth-corner-bl{left:3px;bottom:3px;border-left:2px solid #2e2e34;border-bottom:2px solid #2e2e34}.d-fui-auth-corner-br{right:3px;bottom:3px;border-right:2px solid #2e2e34;border-bottom:2px solid #2e2e34}.d-fui-auth.d-fui-auth-is-active .d-fui-auth-corner{border-color:#fa7319}
.d-fui-auth-announcement{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0)}.d-fui-auth-stage-line{position:absolute;z-index:11;left:13px;right:13px;top:31px;height:1px;background:#fa7319;opacity:.06;pointer-events:none;animation:d-fui-auth-stage-drift 5.2s linear infinite}
