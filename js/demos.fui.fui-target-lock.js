...
.d-fui-lock-tracking{display:flex;align-items:center;gap:6px;color:#a78bfa}.d-fui-lock-tracking-dot{width:5px;height:5px;border-radius:50%;background:#a78bfa;box-shadow:0 0 10px rgba(167,139,250,.35);animation:d-fui-lock-activity 1.6s ease-in-out infinite}
...
.d-fui-lock-reticle{position:absolute;z-index:3;left:0;top:0;width:42px;height:42px;pointer-events:none;will-change:transform}.d-fui-lock-reticle-circle{position:absolute;left:10px;top:10px;width:20px;height:20px;box-sizing:border-box;border:1px solid #5c5c66;border-radius:50%}.d-fui-lock-reticle-h,.d-fui-lock-reticle-v{position:absolute;background:#5c5c66;opacity:.8}.d-fui-lock-reticle-h{left:0;top:20px;width:42px;height:1px}.d-fui-lock-reticle-v{left:20px;top:0;width:1px;height:42px}.d-fui-lock-reticle-dot{position:absolute;left:19px;top:19px;width:3px;height:3px;background:#a78bfa;box-shadow:0 0 8px rgba(167,139,250,.35)}
.d-fui-lock-brackets{position:absolute;z-index:5;inset:0;pointer-events:none}.d-fui-lock-bracket{position:absolute;left:0;top:0;width:10px;height:10px;box-sizing:border-box;opacity:0;will-change:transform,opacity}.d-fui-lock-bracket-tl{border-left:2px solid #a78bfa;border-top:2px solid #a78bfa}.d-fui-lock-bracket-tr{border-right:2px solid #a78bfa;border-top:2px solid #a78bfa}.d-fui-lock-bracket-bl{border-left:2px solid #a78bfa;border-bottom:2px solid #a78bfa}.d-fui-lock-bracket-br{border-right:2px solid #a78bfa;border-bottom:2px solid #a78bfa}
.d-fui-lock-readout{position:absolute;z-index:6;min-width:128px;height:18px;box-sizing:border-box;padding:5px 6px 3px;border-top:1px solid #a78bfa;background:rgba(10,10,11,.88);color:#a78bfa;font:8px/1 'JetBrains Mono',monospace;letter-spacing:.04em;opacity:0;pointer-events:none;transition:opacity 120ms linear;font-variant-numeric:tabular-nums}
.d-fui-lock-scanline{position:absolute;z-index:1;left:0;top:31px;width:1px;height:250px;background:#a78bfa;box-shadow:0 0 8px rgba(167,139,250,.35);opacity:.16;pointer-events:none;animation:d-fui-lock-scan 6s linear infinite}
...
@keyframes d-fui-lock-border-pulse{0%,100%{opacity:.05;box-shadow:0 0 12px rgba(167,139,250,.05)}50%{opacity:.2;box-shadow:0 0 12px rgba(167,139,250,.35)}}
...
@media(prefers-reduced-motion:reduce){.d-fui-lock *{animation:none!important;transition-duration:1ms!important}.d-fui-lock-chip.d-fui-lock-is-locked .d-fui-lock-chip-glow{opacity:.2;box-shadow:0 0 12px rgba(167,139,250,.2)}.d-fui-lock-scanline{left:50%;opacity:.16}.d-fui-lock-tracking-dot{opacity:1}}
`,
...
if(!reduced)requestAnimationFrame(frame);`,
  prompt:`Build a self-contained 320px-tall FUI target-acquisition stage using JetBrains Mono and only the dark palette #0a0a0b, #101012, #161619, #232327, #2e2e34, #ececef, #9b9ba3, #5c5c66, and accent #a78bfa. Use 4px hard-tech surfaces, scanlines, small corner ticks, and a faint dot grid with an exact 24px pitch. Keep one accent tracking light visibly active while idle.
