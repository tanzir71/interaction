...
.d-ascii-fluid:focus-visible{box-shadow:inset 0 0 0 2px rgba(250,115,25,.72)}
...
.d-ascii-fluid-reticle{position:absolute;z-index:4;left:50%;top:50%;box-sizing:border-box;border:1px solid rgba(250,115,25,.72);border-radius:50%;opacity:0;box-shadow:0 0 12px rgba(250,115,25,.18);transform:translate(-50%,-50%);pointer-events:none}.d-ascii-fluid-reticle i{position:absolute;left:50%;top:50%;width:3px;height:3px;border-radius:50%;background:#fa7319;box-shadow:0 0 8px rgba(250,115,25,.35);transform:translate(-50%,-50%)}.d-ascii-fluid[data-reticle-active="true"] .d-ascii-fluid-reticle{opacity:.9}
