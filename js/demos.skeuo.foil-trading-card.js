...
.d-skeuo-foil-trading-card-stage{position:absolute;top:35px;right:12px;bottom:23px;left:12px;display:grid;place-items:center;overflow:hidden;border:1px solid #232327;border-radius:10px;background:radial-gradient(circle at 50% 45%,rgba(250,115,25,.08),transparent 48%),linear-gradient(145deg,#101012,#0d0d0f);perspective:700px}
...
.d-skeuo-foil-trading-card-card:focus-visible{box-shadow:0 18px 34px rgba(0,0,0,.46),0 0 0 2px #0a0a0b,0 0 0 3px #fa7319}
...
.d-skeuo-foil-trading-card-foil-color{opacity:.6;background:linear-gradient(120deg,transparent 13%,#fa7319 31%,#67e8f9 50%,#4ade80 69%,transparent 87%);background-size:220% 220%;background-position:var(--foil-x) var(--foil-y);mix-blend-mode:color-dodge}
...
.d-skeuo-foil-trading-card-sparkles i::before,.d-skeuo-foil-trading-card-sparkles i::after{position:absolute;top:50%;left:50%;background:#fa7319;box-shadow:0 0 6px rgba(250,115,25,.6);content:''}
