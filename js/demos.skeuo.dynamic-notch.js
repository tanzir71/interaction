...
INTRX.register({
  ...
  css:`
.d-skeuo-dynamic-notch{position:relative;width:100%;height:320px;box-sizing:border-box;overflow:hidden;contain:layout paint;container-type:inline-size;background:#0a0a0b;color:#ececef;font-family:'JetBrains Mono',ui-monospace,SFMono-Regular,Consolas,monospace;isolation:isolate}
.d-skeuo-dynamic-notch *{box-sizing:border-box}
.d-skeuo-dynamic-notch-head,.d-skeuo-dynamic-notch-foot{position:absolute;right:14px;left:14px;z-index:3;display:flex;align-items:center;justify-content:space-between;color:#5c5c66;font-size:9px;line-height:1;letter-spacing:.08em;pointer-events:none}
.d-skeuo-dynamic-notch-head{top:15px}.d-skeuo-dynamic-notch-foot{bottom:10px;font-size:8px}
.d-skeuo-dynamic-notch-stage{position:absolute;top:38px;right:12px;bottom:27px;left:12px;overflow:hidden;border:1px solid #29292f;border-radius:10px;background:radial-gradient(circle at 18% 82%,rgba(103,232,249,.14),transparent 38%),radial-gradient(circle at 82% 20%,rgba(167,139,250,.2),transparent 44%),linear-gradient(145deg,#25232d,#14151b 58%,#101012)}
.d-skeuo-dynamic-notch-stage::before{content:'';position:absolute;inset:0;background:linear-gradient(118deg,transparent 0 36%,rgba(255,255,255,.035) 36.2% 36.6%,transparent 36.8% 62%,rgba(167,139,250,.06) 62.2% 62.6%,transparent 62.8%);pointer-events:none}
...
.d-skeuo-dynamic-notch-island{position:absolute;z-index:3;top:11px;left:50%;width:90px;height:24px;padding:0;overflow:hidden;border:0;border-radius:999px;background:#000;color:#ececef;appearance:none;outline:none;cursor:pointer;transform:translateX(-50%) scale(1);transform-origin:50% 0;transition:transform .18s ease;will-change:width,height,border-radius,transform}
.d-skeuo-dynamic-notch-island:focus-visible{box-shadow:0 0 0 2px rgba(167,139,250,.72),0 8px 24px rgba(0,0,0,.38)}
.d-skeuo-dynamic-notch-island.d-skeuo-dynamic-notch-expanded:hover{transform:translateX(-50%) scale(1.06)}
.d-skeuo-dynamic-notch-sensor{position:absolute;top:50%;left:50%;width:8px;height:8px;border:1px solid #18181b;border-radius:50%;background:#070708;opacity:1;transform:translate(-50%,-50%)}
.d-skeuo-dynamic-notch-sensor i{position:absolute;top:2px;left:2px;width:2px;height:2px;border-radius:50%;background:#182637;box-shadow:0 0 3px rgba(103,232,249,.3)}
...
.d-skeuo-dynamic-notch-ring{position:relative;width:21px;height:21px;flex:0 0 21px;border-radius:50%;background:conic-gradient(#fbbf24 0 var(--timer-angle,360deg),#26262b var(--timer-angle,360deg) 360deg)}
...
.d-skeuo-dynamic-notch-timer-copy small{color:#777780;font:600 6px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:.1em}
.d-skeuo-dynamic-notch-timer-copy b{color:#f2f2f4;font:600 11px/1 'JetBrains Mono',ui-monospace,monospace;font-variant-numeric:tabular-nums}
.d-skeuo-dynamic-notch-player{gap:8px;padding:0 10px}
.d-skeuo-dynamic-notch-album{position:relative;width:36px;height:36px;flex:0 0 36px;border-radius:7px;overflow:hidden;background:linear-gradient(145deg,#a78bfa 0 44%,#67e8f9 45% 66%,#31244b 67%)}
...
.d-skeuo-dynamic-notch-album::after{content:'';position:absolute;top:15px;left:15px;width:6px;height:6px;border-radius:50%;background:#121216}
.d-skeuo-dynamic-notch-track{min-width:0;display:grid;flex:1;gap:4px;text-align:left;white-space:nowrap}
.d-skeuo-dynamic-notch-track b{overflow:hidden;color:#ececef;font:600 9px/1 system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;text-overflow:ellipsis}
.d-skeuo-dynamic-notch-track small{overflow:hidden;color:#72727c;font:500 7px/1 system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;text-overflow:ellipsis}
.d-skeuo-dynamic-notch-equalizer{height:18px;display:flex;align-items:flex-end;gap:2px;flex:0 0 13px}
.d-skeuo-dynamic-notch-equalizer i{width:3px;height:var(--bar-height,5px);border-radius:2px;background:#4ade80;box-shadow:0 0 4px rgba(74,222,128,.24)}
...
.d-skeuo-dynamic-notch-wallpaper-copy b{font:500 30px/1 system-ui,-apple-system,sans-serif;letter-spacing:-.04em}.d-skeuo-dynamic-notch-wallpaper-copy small{color:rgba(236,236,239,.38);font:600 7px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:.12em}
...
.d-skeuo-dynamic-notch-window i{height:3px;border-radius:3px;background:rgba(236,236,239,.12)}.d-skeuo-dynamic-notch-window i:nth-child(2){width:72%}.d-skeuo-dynamic-notch-window i:nth-child(3){width:48%;background:rgba(167,139,250,.23)}
.d-skeuo-dynamic-notch-mode{color:#a78bfa}
