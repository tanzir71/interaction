...
.d-micro-btn-polish-stages-stage{position:absolute;top:38px;right:12px;bottom:27px;left:12px;overflow:hidden;border:1px solid #232327;border-radius:10px;background:radial-gradient(circle at 50% 46%,rgba(167,139,250,.08),transparent 36%),#101012;cursor:pointer}
...
.d-micro-btn-polish-stages-button::after{content:'';position:absolute;inset:-1px;border:1px solid #a78bfa;border-radius:inherit;opacity:0;pointer-events:none}
...
.d-micro-btn-polish-stages-s4 .d-micro-btn-polish-stages-button:focus-visible,.d-micro-btn-polish-stages-s5 .d-micro-btn-polish-stages-button:focus-visible{outline:2px solid rgba(167,139,250,.4);outline-offset:4px}
...
.d-micro-btn-polish-stages-ghost small{position:absolute;top:17px;left:8px;color:#a78bfa;font:700 6px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:.08em}
.d-micro-btn-polish-stages-mode{color:#a78bfa}
