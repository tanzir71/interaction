...
.d-ascii-portrait:focus-visible{box-shadow:inset 0 0 0 2px rgba(250,115,25,.72)}
...
function renderPortrait(){
  ...
  for(let index=0;index<cellCount;index++){
    ...
    if(glyph!==' '&&reveal<.999){context.globalAlpha=1-reveal;context.fillStyle=accentFlags[index]?'#fa7319':'#9b9ba3';context.fillText(glyph,(x+.5)*cellWidth,(y+.5)*cellHeight+.5)}
  }
