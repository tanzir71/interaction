...
.d-fui-boot-topbar{z-index:2;display:flex;align-items:center;justify-content:space-between;color:#5c5c66;font-size:9px;line-height:1;letter-spacing:.08em}.d-fui-boot-link{display:flex;align-items:center;gap:6px;color:#9b9ba3}.d-fui-boot-link-dot{width:5px;height:5px;border-radius:50%;background:#fa7319;box-shadow:0 0 9px rgba(250,115,25,.35);animation:d-fui-boot-link-pulse 1.6s ease-in-out infinite}
...
.d-fui-boot-line{height:15px;min-width:0;overflow:hidden;color:#9b9ba3;opacity:1;transform:translateY(0);animation:d-fui-boot-line-in 120ms cubic-bezier(.22,1,.36,1) both}.d-fui-boot-line span{color:#5c5c66}.d-fui-boot-line b{display:inline-block;min-width:31px;color:#5c5c66;font-weight:500}.d-fui-boot-line b.d-fui-boot-ok{color:#4ade80}.d-fui-boot-line b.d-fui-boot-warn{color:#fbbf24}.d-fui-boot-line.d-fui-boot-ready{color:#fa7319;font-weight:500;letter-spacing:.08em}.d-fui-boot-line.d-fui-boot-ready span{color:#fa7319}
...
.d-fui-boot-footer{position:relative;z-index:2;display:grid;grid-template-rows:12px 22px;gap:2px}.d-fui-boot-progress-head{display:flex;align-items:center;justify-content:space-between;color:#5c5c66;font-size:8px;line-height:1;letter-spacing:.08em}.d-fui-boot-phase{color:#9b9ba3}.d-fui-boot-progress-row{display:flex;align-items:center;gap:7px;min-width:0;border-top:1px solid #232327}.d-fui-boot-progress{color:#fa7319;font:12px/1 'JetBrains Mono',monospace;letter-spacing:1px;white-space:nowrap}.d-fui-boot-cursor{color:#fa7319;font:12px/1 'JetBrains Mono',monospace;animation:d-fui-boot-cursor-blink 530ms steps(1,end) infinite}
.d-fui-boot-announcement{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0)}.d-fui-boot-scanline{position:absolute;z-index:6;left:13px;right:13px;top:31px;height:1px;background:#fa7319;box-shadow:0 0 8px rgba(250,115,25,.35);opacity:.1;pointer-events:none;animation:d-fui-boot-scan 4.8s linear infinite}
.d-fui-boot.d-fui-boot-is-wiping .d-fui-boot-screen-inner{animation:d-fui-boot-wipe 250ms cubic-bezier(.65,0,.35,1) forwards}.d-fui-boot.d-fui-boot-is-ready .d-fui-boot-corner{border-color:#fa7319}.d-fui-boot.d-fui-boot-is-ready .d-fui-boot-phase{color:#fa7319}
...
if(reduced)renderReduced();else begin();`,
  prompt:`Build a self-contained 320px-tall fictional boot terminal on #0a0a0b with #101012 panels, #232327 and #2e2e34 framing, primary #ececef, secondary #9b9ba3 and #5c5c66 text, accent #fa7319, success #4ade80, and warning #fbbf24. Use JetBrains Mono at exactly 12px for output, 4px hard-tech corners, four 8px corner ticks, a scanline texture, and an always-visible accent cursor or activity light.
