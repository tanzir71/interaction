...
.d-ascii-type-explode-readout{color:#9b9ba3}.d-ascii-type-explode[data-flying-cells]:not([data-flying-cells="0"]) .d-ascii-type-explode-readout{color:#ececef}.d-ascii-type-explode[data-scatter-cell-count]:not([data-scatter-cell-count="0"]) .d-ascii-type-explode-readout{color:#fa7319}
...
.d-ascii-type-explode-well:focus-within{border-color:#fa7319;box-shadow:0 0 0 1px rgba(250,115,25,.16)}.d-ascii-type-explode-well>span,.d-ascii-type-explode-well>b{font-size:8px;font-weight:700;white-space:nowrap}.d-ascii-type-explode-well>b{color:#47474f}
.d-ascii-type-explode-well input{min-width:0;width:100%;height:28px;box-sizing:border-box;padding:0;border:0;outline:0;background:transparent;color:#ececef;caret-color:#fa7319;font:700 14px/28px 'JetBrains Mono',monospace;letter-spacing:.15em;text-transform:uppercase}.d-ascii-type-explode-well input::placeholder{color:#5c5c66;opacity:1}
